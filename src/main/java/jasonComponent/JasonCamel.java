...
public class JasonCamel extends DefaultPlatformImpl{
	private final static Logger logger = Logger.getLogger(JasonCamel.class.getName());
	...
	public void init(String[] args) throws Exception{
		...
		for (AgentParameters ap: project.getAgents()) {
			if (ap.getNbInstances() > 0) {
				lags.add(ap);
				ap.insertArchClass(new ClassParameters(CamelAgArch.class.getName()));
			}
		}
